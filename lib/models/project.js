...
class Project {
  ...
  */
   ...
   */
  isEmberCLIProject() {
    return (this.cli ? this.cli.npmPackage : 'bottled-ember-cli') in this.dependencies();
  }
...
function isEmberCliProject(pkg) {
  return (
    pkg &&
    ((pkg.dependencies && Object.keys(pkg.dependencies).indexOf('bottled-ember-cli') !== -1) ||
      (pkg.devDependencies && Object.keys(pkg.devDependencies).indexOf('bottled-ember-cli') !== -1))
  );
}
